...
class DattaguruArtiScreen extends StatefulWidget {
  const DattaguruArtiScreen({super.key});

  @override
  State<DattaguruArtiScreen> createState() => _DattaguruArtiScreenState();
}

class _DattaguruArtiScreenState extends State<DattaguruArtiScreen> {
  @override
