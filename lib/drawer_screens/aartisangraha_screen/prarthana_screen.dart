...
class PrarthanaScreen extends StatefulWidget {
  const PrarthanaScreen({super.key});

  @override
  State<PrarthanaScreen> createState() => _PrarthanaScreenState();
}

class _PrarthanaScreenState extends State<PrarthanaScreen> {
  @override
