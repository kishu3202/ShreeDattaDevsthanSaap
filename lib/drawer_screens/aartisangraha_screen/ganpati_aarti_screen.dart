...
import 'package:shree_datta_devsthan_saap/drawer_screens/aartisangraha_screen/aarti_screen.dart';
import 'package:shree_datta_devsthan_saap/drawer_screens/aartisangraha_screen/devi_aarti_screen.dart';

class GanpatiAartiScreen extends StatefulWidget {
  const GanpatiAartiScreen({super.key});

  @override
  State<GanpatiAartiScreen> createState() => _GanpatiAartiScreenState();
}

class _GanpatiAartiScreenState extends State<GanpatiAartiScreen> {
  @override
